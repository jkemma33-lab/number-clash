...
- The initial board uses 1 to 9 with equal counts: four of each number, 36 numbers total.
...
- The game ends when every number is cleared, or when no valid pair remains after all five additions are used.
